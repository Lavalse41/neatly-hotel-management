...
paymentMethodRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const paymentId = req.params.id;
        const { data: payment, error } = yield supabase
            .from("credit_card")
            .select("*")
        ...
        const decryptedPayment = Object.assign(Object.assign({}, payment), { cvc: decryptCVC(payment.cvc, encryptKey) });
        res.status(200).json({
...
paymentMethodRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const paymentId = req.params.id;
